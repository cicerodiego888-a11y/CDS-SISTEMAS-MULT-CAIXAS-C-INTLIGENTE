...
═══════════════════════════════</pre>
                            ...
                            <div class="d-flex flex-wrap gap-2 mt-2">
                                ...
                                ` : ''}
                                ${!/autorizad/i.test(String(n.status || '')) && (acoes.downloadXml || n.tem_xml) ? `<button type="button" class="btn btn-sm btn-outline-secondary" onclick="baixarXmlNfe55({tipo:'DEVOLUCAO_COMPRA',id:${n.id},chave:'${escapeHtml(n.chave_acesso || '')}'})">XML assinado</button>` : ''}
                                ${n.tem_danfe_cancelado ? `<button type="button" class="btn btn-sm btn-outline-secondary" onclick="abrirDanfe({tipo:'DEVOLUCAO_COMPRA',id:${n.id},chave:'${escapeHtml(n.chave_acesso || '')}'})">DANFE cancelado</button>` : ''}
