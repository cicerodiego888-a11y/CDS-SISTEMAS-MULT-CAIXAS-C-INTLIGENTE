/**
 * Super Usuário — pedir NCM no PDV quando o produto não tem cadastro
 * e gravar no produto (mesmo padrão do preço unitário).
 * Padrão: DESATIVADO.
 */
'use strict';

const CHAVE = 'pdv_exigir_ncm_cadastro';
const ATIVADO = 'ATIVADO';
const DESATIVADO = 'DESATIVADO';
const DESCRICAO =
  'No PDV, se o produto não tiver NCM, pedir o código e atualizar o cadastro';
