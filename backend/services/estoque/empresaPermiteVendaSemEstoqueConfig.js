/**
 * Super Usuário — permitir venda com saldo insuficiente.
 * Padrão: DESATIVADO (bloqueia como hoje).
 * ATIVADO: a venda segue baixando estoque (pode ficar negativo);
 * entrada/compra/ajuste não mudam.
 */
'use strict';

const CHAVE = 'empresa_permite_venda_sem_estoque';
const ATIVADO = 'ATIVADO';
const DESATIVADO = 'DESATIVADO';
const DESCRICAO =
  'Permitir venda sem estoque (baixa continua; saldo pode ficar negativo)';
