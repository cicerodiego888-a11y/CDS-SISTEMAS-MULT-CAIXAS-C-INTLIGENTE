/**
 * Controle Super Usuário — edição do preço unitário no carrinho do PDV
 * com atualização automática do cadastro do produto.
 * Padrão: DESATIVADO.
 */
'use strict';

const CHAVE = 'pdv_permitir_editar_preco_unitario';
const ATIVADO = 'ATIVADO';
const DESATIVADO = 'DESATIVADO';
const DESCRICAO =
  'Permitir editar preço unitário no PDV e atualizar cadastro do produto';
