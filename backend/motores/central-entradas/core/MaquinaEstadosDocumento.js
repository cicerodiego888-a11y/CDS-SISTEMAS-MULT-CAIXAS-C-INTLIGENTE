...
const TRANSICOES_PERMITIDAS = Object.freeze({
  ...
  [S.RESUMO_RECEBIDO]: [
    S.XML_COMPLETO,
    S.XML_INDISPONIVEL,
    S.RECUPERACAO_ESGOTADA,
    S.FORA_JANELA_RECUPERACAO,
    S.ERRO_RECUPERACAO,
    S.CANCELADA,
    S.DENEGADA,
    S.INUTILIZADA,
  ...
  [S.RECUPERACAO_ESGOTADA]: [S.XML_COMPLETO, S.RESUMO_RECEBIDO, S.FINALIZADA],
  [S.FORA_JANELA_RECUPERACAO]: [S.FINALIZADA],
  [S.ERRO_RECUPERACAO]: [S.XML_COMPLETO, S.RESUMO_RECEBIDO, S.FINALIZADA],
